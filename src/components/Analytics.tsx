            ...
            {filteredAnalytics.map((exercise) => {
              ...
              return (
                ...
                >
                  <div className="mb-3">
                    <div className="flex items-center gap-2 mb-2">
                      <h4 className="text-sm sm:text-base text-green-400 font-semibold flex-[3] min-w-0">
                        {exercise.name}{" "}
                        <span
                  ...
                  <div className="grid grid-cols-3 gap-2 sm:gap-3 mt-3 pt-3 border-t border-green-900/30">
                    <div className="text-center">
                      <div className="text-green-700 text-xs mb-0.5">Avg</div>
                      <div className="text-green-400 font-semibold text-sm sm:text-base">
                        {exercise.avgWeight.toFixed(1)}kg
                      </div>
                    </div>
                    <div className="text-center">
                      <div className="text-green-700 text-xs mb-0.5">Logs</div>
                      <div className="text-green-400 font-semibold text-sm sm:text-base">
                        {exercise.logs.length}
                      </div>
                    </div>
                    <div className="text-center">
                      <div className="text-green-700 text-xs mb-0.5">Last</div>
                      <div className="text-green-400 font-semibold text-xs">
                        {exercise.lastLog.date.toLocaleDateString("en-US", {
                          month: "short",
                          day: "numeric",
                        })}
                      </div>
